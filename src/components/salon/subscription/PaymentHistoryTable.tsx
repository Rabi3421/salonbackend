        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50">
              ...
              <th className="whitespace-nowrap px-4 py-3 font-medium text-slate-600">Mode</th>
              <th className="whitespace-nowrap px-4 py-3 font-medium text-slate-600">Date</th>
              <th className="whitespace-nowrap px-4 py-3 font-medium text-slate-600">Status</th>
              <th className="whitespace-nowrap px-4 py-3 font-medium text-slate-600">Receipt</th>
